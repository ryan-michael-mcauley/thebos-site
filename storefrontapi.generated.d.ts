...
export type IntroQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type IntroQuery = {
  metaobject?: StorefrontAPI.Maybe<{
    fields: Array<
      Pick<StorefrontAPI.MetaobjectField, 'key' | 'type' | 'value'>
    >;
...
export type WhyusQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type WhyusQuery = {
  metaobjects: {
    nodes: Array<{
      fields: Array<
        Pick<StorefrontAPI.MetaobjectField, 'type' | 'value' | 'key'>
      >;
    }>;
  };
};
...
export type ProductsQuery = {
  products: {
    edges: Array<{
      node: Pick<StorefrontAPI.Product, 'handle' | 'title'> & {
...
export type CustomerDetailsQuery = {
  customer?: StorefrontAPI.Maybe<
    ...
    > & {
      defaultAddress?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.MailingAddress, 'city'>
      >;
      orders: {
        edges: Array<{
          node: Pick<
